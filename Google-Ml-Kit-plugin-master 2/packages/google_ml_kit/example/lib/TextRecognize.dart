...
class _TextRecognizeState extends State<TextRecognize> {
  ...
  Future<String> imagetoBase64(XFile? file) async{
    ...
    String url ='https://aip.baidubce.com/rest/2.0/ocr/v1/accurate_basic?access_token=24.18ae9d7329d65f40a1327c501d242181.2592000.1674063660.282335-29169287%22';
    ...
    print(response.data['words_result'].length);
    setState(() {});
    return base64Image;
  }
}
